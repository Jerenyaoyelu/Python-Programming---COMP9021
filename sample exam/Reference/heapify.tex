...
\node[draw] {6}
    ...
    child {node[draw, fill=green] {0}
        child {node[draw] {9}}
        child {node[draw, fill=green] {8}}
    };
\end{tikzpicture}
