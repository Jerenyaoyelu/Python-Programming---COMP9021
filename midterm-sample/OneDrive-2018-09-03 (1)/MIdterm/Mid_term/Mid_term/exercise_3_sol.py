...
def f(n):
    ...
    while  x % 10 == 0:
        x //= 10
    nb_of_digits_excluding_the_trailing_0s = len(str(x))
    print(n, 'factorial is', n_factorial)
    print('It has', nb_of_digits_excluding_the_trailing_0s, end = ' ')
    print('digit,', end = ' ') if nb_of_digits_excluding_the_trailing_0s == 1\
                                                                    else print('digits,', end = ' ')
    print("the trailing 0's excepted")
