...
'''
A number of functions to essentially, get as input two nonempty
strings of digits, sigma and tau, and compute natural numbers a and b
such that a / b is reduced and equal to 0.(sigma)(tau)(tau)(tau)(tau)...
'''


def determine_reduced_fraction_from_pattern_and_repeated_pattern():
    '''
    Gets as input two nonempty strings of digits, sigma and tau,
